        ...
        while currentDay<=Settings.endTime:
            ...
            for noOfDays in noOfDaysList: 
                for dataType in dataTypes:
                    ...
                    data['value'] = classifier.getAccuracy(TestDocuments(currentTime=currentDay+timedelta(days=1), numberOfExperts=Settings.numberOfExperts, dataType=dataType, noOfDays=1).iterator())
                    print data
