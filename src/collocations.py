...
#        self.collocationsFile = '/tmp/collocations/file'
        finder = BigramCollocationFinder.from_words(Utilities.getWords(fileNameMethod=Utilities.getTrainingFile, dataDirection=DataDirection.past, **self.kwargs), window_size = 20)
